...
inclusive OR (C<v>, C<|>, or C<||>), and/or logical exclusive OR (C<x> or
C<X>).  Statements may be grouped within parentheses and negated with C<->,
...
statement false, and C<< <-> >>, which creates a statement which is true if and
